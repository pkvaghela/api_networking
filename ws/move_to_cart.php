<?php 
    /*
        ...
        how to call : http://localhost/flutter/ws/move_to_cart.php?usersid=1&productid=5
        output : 
    ...
    */
    ...
    else
    {
       ...
       $sql = "select id from cart where billid=0 and productid= {$input['productid']} and {$input['usersid']}";
