<?php 
    /*
        ...
        how to call : http://localhost/flutter/ws/wishlist.php?usersid=3
        output : 
        1) [{"error":"input is missing"}]
        2) [{"error":"no"},{"total":0}]
        3) [{"error":"no"},{"total":1},{"id":"1","title":"Acer Laptop","price":"100","weight":"3000","size":"15 inch","photo":"acer.jpg","detail":"WINDOWS 10 4 GB DDR3 RAM 128 gb ssd hard disk"}]
